...
# the dictionary is a convenent way to be able to refer to each colour by a name rather than a number
...
for idx, shape in enumerate(shapes):
    ...
    # draw the shape on screen for a set duration of time (defined in "flips", which have the duration of a single frame)
